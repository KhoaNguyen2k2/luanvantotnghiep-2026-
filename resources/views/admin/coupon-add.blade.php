                                ...
                                <div class="wg-box">
                                    <form class="form-new-product form-style-1" method="POST" action="{{ route('admin.coupon.store') }}">
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Mã giảm giá" name="code" tabindex="0" value="{{ old('code') }}" aria-required="true" required="">
                                        </fieldset>
                                        ...
                                        <fieldset class="category">
                                            ...
                                            <div class="select flex-grow">
                                                <select name="scope" id="js-coupon-scope" required>
                                                    ...
                                                    <option value="order" {{ old('scope') == 'order' ? 'selected' : '' }}>Toàn bộ hoá đơn</option>
                                                    <option value="category" {{ old('scope') == 'category' ? 'selected' : '' }}>Theo danh mục (RAM, CPU, VGA…)</option>
                                                </select>
                                            </div>
                                        ...
                                        <div id="js-coupon-category-wrap" class="js-coupon-category-block" @if(old('scope', 'order') !== 'category') style="display: none" @endif>
                                        <fieldset class="category">
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Giá trị giỏ hàng tối thiểu" name="cart_value" tabindex="0" value="{{ old('cart_value') }}" aria-required="true" required="">
                                        </fieldset>
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="date" placeholder="Ngày hết hạn" name="expiry_date" tabindex="0" value="{{ old('expiry_date') }}" aria-required="true" required="">
                                        </fieldset>
